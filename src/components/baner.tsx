...
export default function Baner() {
  ...
  const dateLeft =targetDate.days
    ...
    <div className='md:px-4'>
        <div className="absolute z-20 top-[50%] left-[50%] transform -translate-x-[50%] px-6  rounded-b-lg flex flex-col  text-center
       sm:top-[40%] sm:px-8 pt-3 pb-5  md:px-10 md:flex-row md:text-left  md:top-[65%]
        bg-radial-[at_50%_99%]  from-purple-900 via-purple-950 to-black to-100% w-full max-w-[1100px] 
            text-white  md:rounded-t-2xl md:rounded-b-2xl  lg:pt-6 lg:bottom-4" >
            <div className='mb-5 md:mb-10'>
                <div className='font-sembold text-lx  mb-[10px] md:text-base lg:text-2xl lg:mb-4'>September 22nd, 2025</div>
                <div className='font-bold text-lx mb:text-2xl lg:text-2xl'>
